...
class ControllerAdministration
{
    ...
    { //affiche formulaire de creation de compte
    ...
    { //affiche message de confirmation de creation de compte
        $barre = Session::retourButton();
    ...
    {
        $test = ModelAdministration::checkPassword($_POST['login'], Security::chiffrer($_POST['mot_de_passe']));
        if ($test == true) {
            $_SESSION['login'] = $_POST['login'];
            if (ModelAdministration::estAdmin($_POST['login']) == 1) {
                $_SESSION['admin'] = true;
            }
