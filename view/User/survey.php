<div id="survey">
	<form action="index.php?controller=user&action=survey" method="POST">
		<div>
			<p><span>Question 1:</span>Do you like using this web application ?</p>
			<p>
		...
		<div>
			<p><span>Question 2:</span>Did you like the timetable organisation ?</p>
			<p>
		...
		<div>
			<p><span>Question 3:</span>Do you like studying in our university ?</p>
			<p>
		...
		<div>
			<p><span>Question 4:</span>Blabla question blabla ?</p>
			<p>
		...
		<div>
			<p><span>Question 5:</span>Did you like answering this survey ?</p>
			<p>
