            ...
            <div>
                <form method="post" action="index.php?controller=administration.ctrl&action=created">
                    <fieldset>
                        ...
                        <p>
                            Birth Date :
                            <input type="date" name="birthdate" value="<?php if (isset($_POST['date_naissance'])) {
                                echo htmlspecialchars($_POST['birthdate']);
                            } ?>" required/>
                        </p>
                        <p>
                            Email :
                            <input type="email" placeholder="mail@uwe.ac.uk" name="mail"
                        ...
                        <p>
                            Phone Number :
                            <input type="tel" placeholder="phone number" name="num_phone"
                                   value="<?php if (isset($_POST['num_phone'])) {
                                       echo htmlspecialchars($_POST['num_phone']);
                                   } ?>" required/>
                        </p>
                        <p>
                            New Password
                        ...
                        <p>
                            Verify New password
                            <input type="password" pattern="^\S{6,}$" placeholder="passw0rd" name="conf_password"
                                   required/>
                        </p>
                        <p>
